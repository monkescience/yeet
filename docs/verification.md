...
cosign verify \
  ...
  --certificate-oidc-issuer https://token.actions.githubusercontent.com \
  ghcr.io/monkescience/yeet:v0.13.9-beta.1 # x-yeet-version
```
...
```sh
gh attestation verify oci://ghcr.io/monkescience/yeet:v0.13.9-beta.1 --repo monkescience/yeet # x-yeet-version
```
