...
func TestReleaseSubjectFormatting(t *testing.T) {
	...
	t.Run("default subject omits branch and tag prefix", func(t *testing.T) {
		...
		testastic.True(t, strings.HasSuffix(strings.TrimSpace(result.PullRequest.Body), "_Generated by yeet_"))
		testastic.False(t, strings.Contains(result.Changelog, "_Generated by yeet_"))
	...
	t.Run("custom header and footer wrap PR body only", func(t *testing.T) {
		...
		testastic.False(t, strings.Contains(result.PullRequest.Body, "_Generated by yeet_"))
