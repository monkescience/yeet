...
Self-hosted setup is covered in [Authentication](#authentication).
...
```sh
go install github.com/monkescience/yeet/cmd/yeet@v0.10.11 # x-yeet-version
```
...
VERSION = "0.10.11" # x-yeet-version
...
image: ghcr.io/acme/app:0.10.11
appVersion: "0.10.11"
# x-yeet-end
```
