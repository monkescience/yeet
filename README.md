...
```sh
go install github.com/monkescience/yeet/cmd/yeet@v0.11.0-beta.1 # x-yeet-version
```

Or use the published container image:

```sh
docker run --rm ghcr.io/monkescience/yeet:v0.11.0-beta.1 --help # x-yeet-version
```
...
cosign verify \
  ...
  --certificate-oidc-issuer https://token.actions.githubusercontent.com \
  ghcr.io/monkescience/yeet:v0.11.0-beta.1 # x-yeet-version
```
...
gh attestation verify oci://ghcr.io/monkescience/yeet:v0.11.0-beta.1 --repo monkescience/yeet # x-yeet-version
```
