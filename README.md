...
```sh
go install github.com/monkescience/yeet/cmd/yeet@v0.13.9-beta.1 # x-yeet-version
docker run --rm ghcr.io/monkescience/yeet:v0.13.9-beta.1 --help # x-yeet-version
```
